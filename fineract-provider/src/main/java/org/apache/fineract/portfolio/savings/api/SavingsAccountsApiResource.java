...
public class SavingsAccountsApiResource {
    ...
    public String retrieveAll(@Context final UriInfo uriInfo,
            ...
            @QueryParam("birthdayMonth") @Parameter(description = "Filter by client birthday month (1-12)") final Integer birthdayMonth,
            @QueryParam("birthdayDay") @Parameter(description = "Filter by client birthday day (1-31)") final Integer birthdayDay) {
